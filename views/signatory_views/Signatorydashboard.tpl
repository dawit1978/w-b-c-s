        ...
        <div class="navbar">
            <div class="navbar-inner">
                <form class="navbar-form pull-right">
                    ...
                    <input id="search" class="span3" type="search" placeholder="Search..." value="{$filter}"
                        ...
                        <div class="btn-group">
                            {if $myStudent_ClearanceStatus[$k] eq 'Cleared'}
                                ...
                                <a class="btn btn-small btn-success"
                                    href="index.php?action=viewClearancePage&stud_id={$myKey_Student_Username[$k]}&sy_sem_id={$sysemid}">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a style="cursor:pointer;"
                                        onclick="window.location.href = 'index.php?action=viewStudent_Detail&stud_id={$myKey_Student_Username[$k]}&sy_sem_id={$sysemid}';">
                                        <i class="icon-info-sign"></i> Detail</a>
                                </li>
                                <li>
                                    <a style="cursor:pointer;"
                                        onclick="window.location.href = 'index.php?action=viewClearancePage&stud_id={$myKey_Student_Username[$k]}&sy_sem_id={$sysemid}';">
