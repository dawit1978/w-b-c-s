...
{function name=nav_user_accounts index=0}
    ...
    <ul class="nav">
        ...
        <li {if $index == 2}class="active" {/if}>
            <a class="tips" href="{$host}/administrator/index.php?user_type=Signatory"
                title="List of Signatories-in-charge">
                <i class="icon-coffee"></i>
            </a>
        </li>
        <li {if $index == 3}class="active" {/if}>
            <a class="tips" href="{$host}/administrator/unconfirmed_signatory.php"
        ...
        {if $index!=1}
            <li class="dropdown">
                <a class="tips" href="{$host}/administrator/index.php?action=addSignatoryInCharge"
    ...
    <ul class="nav">
        ...
        <li {if $index == 2}class="active" {/if}>
            <a class="tips" title="Add Signatory"
                href="{$host}/administrator/signatory_list_manager.php?action=addSignatory">
...
{function name=nav_departments flag=0 index=0}
    ...
    <ul class="nav">
        ...
        {if $flag == 1}
            ...
            <li>
                <a class="tips" data-toggle="tooltip" title="Add Department"
                    href="{$host}/administrator/department_list_manager.php?action=addDepartment">
        ...
        {else}
            ...
            <li {if $index == 1}class="active" {/if}>
                <a class="tips" data-toggle="tooltip" title="List of Course under {$Dept_name}"
                    href='{$host}/administrator/course_list_byDepartment.php'>
                    <i class="icon-book"></i>
                </a>
            </li>
            <li {if $index == 2}class="active" {/if}>
                <a class="tips" data-toggle="tooltip" title="List of Signatory for undergraduates under {$Dept_name}"
                    href='{$host}/administrator/signatorialList.php'>
                    <i class="icon-socs-profile"></i>
                </a>
            </li>
            <li {if $index == 3}class="active" {/if}>
                <a class="tips" data-toggle="tooltip" title="List of Signatory for graduates under {$Dept_name}"
                    href='{$host}/administrator/Grad_SignatorialList.php'>
            ...
            {if $index==1}
                <li class="dropdown">
                    <a class="tips" data-toggle="tooltip" title="Add Course under {$Dept_name}"
                        href='{$host}/administrator/course_list_byDepartment.php?action=addCourse'>
...
{function name="upload_excel"}
    ...
    <div id="upload_excel" class="modal hide fade">
        ...
        <div class="fileupload fileupload-new" data-provides="fileupload">
            <form class="form-horizontal" action="{$host}/administrator/index.php?action=upload_excel_file" method="post"
