...
<form method='post' class="form-horizontal" action="{$host}/index.php?action=student_register"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type='text' name='surname' {if isset($s_name)}value="{$s_name}" {/if} pattern="[A-Za-z\s\-]+"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type='text' name='firstname' {if isset($f_name)}value="{$f_name}" {/if} pattern="[A-Za-z\s\.\-]+"
                required title="Letters and spaces only">
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type='text' name='middleName' maxlength="1" {if isset($m_name)}value="{$m_name}" {/if}
