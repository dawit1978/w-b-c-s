...
<form method='post' class="form-horizontal" action="{$host}/signatory_registration.php?action=register"
    ...
    {literal}
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type='text' name='surname' {/literal} 
                    {if isset($s_name)} value="{$s_name}" 
                    {/if} 
                    {literal}
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type='text' name='firstname' {/literal} 
                            {if isset($f_name)} value="{$f_name}" 
                            {/if} 
                            {literal}
                                    pattern="[A-Za-z\s\.\-]{2,32}" required title="Letters and spaces only">
                            </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type='text' name='middleName' maxlength="1" {/literal} 
                                    {if isset($m_name)} value="{$m_name}" 
                                    {/if}
                                        {literal} pattern="[A-Za-z\s\-]+" required title="Letters and spaces only">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type='text' name='emailAdd' {/literal} 
                                            {if isset($e_add)} value="{$e_add}" 
                                            {/if} 
                                            {literal}
                                                pattern="[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)" {/literal} required>
                                        </div>
                                    </div>
