...
class Bulletin_Model extends Model{
    ...
    public function insert($Tsign_id, $Tsy_id, $Tmsg){
         mysqli_query($this->connectdb,"INSERT INTO `socs`.`bulletin` (`Bulletin_ID`, `Signatory_ID`, `SY_SEM_ID`, `Post_Date`, `Post_Time`, `Message`) 
             VALUES (NULL, '$Tsign_id', '$Tsy_id', CURDATE(), CURTIME(), '$Tmsg')");
    }
    
    public function deleteBulletin($Tsign_id){
        mysqli_query($this->connectdb,"delete from bulletin where Bulletin_ID = '$Tsign_id'");
    }
    
    public function filter($sign_id, $sysem_id, $page, $search){
        $this->query = mysqli_query($this->connectdb,"select *, concat(post_date, ' | ', post_time) as datetime  from bulletin where Signatory_ID = '$sign_id' AND sy_sem_id = '$sysem_id' AND
    ...
    public function getListofID($sign_id, $sysem_id, $page, $search){
        $rowInfo = array();
        $this->query = mysqli_query($this->connectdb,"select Bulletin_ID from bulletin where Signatory_ID = '$sign_id' AND sy_sem_id = '$sysem_id' AND
                                    (post_date like '%$search%' OR post_time like '%$search%')
                                    order by post_date desc, post_time desc
                                    LIMIT " . (($page - 1) * $this->itemsPerPage) . ", " . $this->itemsPerPage);
    ...
    public function getListofMessages($sign_id, $sysem_id, $page, $search){
        $rowInfo = array();
        $this->query = mysqli_query($this->connectdb,"select Message from bulletin where Signatory_ID = '$sign_id' AND sy_sem_id = '$sysem_id' AND
                                    (post_date like '%$search%' OR post_time like '%$search%')
                                    order by post_date desc, post_time desc
                                    LIMIT " . (($page - 1) * $this->itemsPerPage) . ", " . $this->itemsPerPage);
    ...
    public function getListofPost_Date($sign_id, $sysem_id, $page , $search){
        $rowInfo = array();
        $this->query = mysqli_query($this->connectdb,"select Post_Date from bulletin where Signatory_ID = '$sign_id' AND sy_sem_id = '$sysem_id' AND
                                    (post_date like '%$search%' OR post_time like '%$search%')
                                    order by post_date desc, post_time desc
                                    LIMIT " . (($page - 1) * $this->itemsPerPage) . ", " . $this->itemsPerPage);
    ...
    public function getListofPost_Time($sign_id, $sysem_id, $page, $search){
        $rowInfo = array();
        $this->query = mysqli_query($this->connectdb,"select Post_Time from bulletin where Signatory_ID = '$sign_id' AND sy_sem_id = '$sysem_id' AND
                                    (post_date like '%$search%' OR post_time like '%$search%')
                                    order by post_date desc, post_time desc
                                    LIMIT " . (($page - 1) * $this->itemsPerPage) . ", " . $this->itemsPerPage);
    ...
    public function ViewBulletin($T_key, $T_sign_id){
        $this->query = mysqli_query($this->connectdb,"select * from bulletin where bulletin_id = '$T_key' AND signatory_id = '$T_sign_id'");
...
//        $this->query = mysqli_query($this->connectdb,"select Message from bulletin where bulletin_id = '$T_key' AND signatory_id = '$T_sign_id'");
//        
//        $row = mysqli_fetch_array($this->query);
//        
//        return $row['Message'];
...
//        $this->query = mysqli_query($this->connectdb,"select post_date from bulletin where bulletin_id = '$T_key' AND signatory_id = '$T_sign_id'");
//        
//        $row = mysqli_fetch_array($this->query);
//        
...
//        $this->query = mysqli_query($this->connectdb,"select post_time from bulletin where bulletin_id = '$T_key' AND signatory_id = '$T_sign_id'");
//        
//        $row = mysqli_fetch_array($this->query);
//        
